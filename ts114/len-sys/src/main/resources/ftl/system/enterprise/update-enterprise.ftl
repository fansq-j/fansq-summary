        ...
        $(document).ready(function() {
            ...
            if(flag){
               // $("form").disable();
                ...
                $("#bt-add").attr("style","display:none;");
  ...
  <form class="layui-form layui-form-pane" style="margin-left: 20px;">
    ...
    <div class="layui-form-item">
      <fieldset class="layui-elem-field layui-field-title" style="margin-top: 10px;">
        ...
        <input type="hidden" value="${enterpriseInformation.id}" name="id">
    <div class="layui-form-item">
      ...
      <div class="layui-input-inline">
        <input type="text"  id="companyName" name="companyName"  lay-verify="companyname"
               autocomplete="off" class="layui-input"  value="${enterpriseInformation.companyName}">
      </div>
    ...
    <div class="layui-inline">
      ...
      <div class="layui-input-inline" id="keyWord">
        <#list keyword as k>
            <input  type="text" id="keyWord" value="${k.name}" name="keyWord" lay-verify="keyWord"  autocomplete="off" class="layui-input">
        </#list>
        ...
        <div class="layui-form-item">
            <div class="layui-inline">
                ...
                <div class="layui-input-inline">
                    <input type="text" value="${enterpriseInformation.companyAddress}" id="companyAddress" name="companyAddress" lay-verify="companyAddress"  autocomplete="off" class="layui-input">
                </div>
            </div>
        ...
        <div class="layui-form-item">
            <div class="layui-inline">
                ...
                <div class="layui-input-inline">
                    <input type="text" id="companyTel" value="${enterpriseInformation.companyTel}" name="companyTel" lay-verify="companyTel"  autocomplete="off" class="layui-input">
                </div>
            </div>
        ...
        <div class="layui-form-item">
            <div class="layui-inline">
                ...
                <div class="layui-input-inline">
                    <input type="text" id="intro" value="${enterpriseInformation.intro}" name="intro" lay-verify="intro"  autocomplete="off" class="layui-input">
                </div>
            </div>
        </div>
        <div class="layui-form-item">
            <div class="layui-inline">
                ...
                <div class="layui-input-inline">
                    <textarea  id="introduce" rows="5" cols="40" name="introduce" lay-verify="introduce"  autocomplete="off">${enterpriseInformation.introduce}</textarea>
                </div>
            </div>
        </div>
        <div class="layui-form-item">
            ...
            <label for="intro" class="layui-form-label">
                <span class="x-red">*</span>公司营业执照：
            </label>
            <img src="/${enterpriseInformation.license}" class="layui-upload-img layui-circle">
  ...
  layui.use(['form','layer'], function(){
   ...
   $('#close').click(function(){
    ...
    form.on('submit(add)', function(data){
      ...
      layerAjax('updateEnterprise',data.field,'enterpriseList');
      return false;
    });
  });
  function ready() {
