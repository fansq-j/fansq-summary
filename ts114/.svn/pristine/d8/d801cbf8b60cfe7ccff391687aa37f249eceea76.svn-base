    ...
    <div style="width:100%;height:400px;overflow: auto;">
      <div class="layui-form-item">
        <fieldset class="layui-elem-field layui-field-title" style="margin-top: 10px;">
          <legend style="font-size:16px;">子类服务类型</legend>
        </fieldset>
      </div>
      <div class="layui-form-item">
        ...
        <div class="layui-input-inline width-input">
          <select lay-verify="required" name="serverId" id="" lay-search>
            <option value="">请选择父类服务</option>
            <#list fserverList as f>
            <option value="${f.id}">${f.serverName}</option>
          </#list>
      ...
      <div class="layui-form-item">
        <label for="serverName" class="layui-form-label">
          <span class="x-red">*</span>子服务名称
        </label>
        <div class="layui-input-inline">
          <input type="text"  id="subclassName" name="subclassName"  lay-verify="subclassName"
      ...
      <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
          <input type="text"  id="priority" name="priority"  lay-verify="priority"
                 autocomplete="off" class="layui-input">
        </div>
        <div id="ms" class="layui-form-mid layui-word-aux">
...
<script>
  ...
  layui.use(['form','layer'], function(){
    ...
    form.on('submit(add)', function(data){
      layerAjax('addZserver', data.field, 'ZserverList');
      return false;
    });
    form.render();
  });
