...
//    }
    ...
    public ShiroFilterFactoryBean getShiroFilterFactoryBean(@Qualifier("securityManager") SecurityManager securityManager) {
        ...
        filterMap.put("/IndexLista", "anon");
        filterMap.put("/IndexListRes", "anon");
        filterMap.put("/CompanyDetails", "anon");
        filterMap.put("/IndexListRess", "anon");
        filterMap.put("/addEnterprise", "anon");
        filterMap.put("/addCompanyTz", "anon");
        filterMap.put("/editMovieInfo", "anon");
        filterMap.put("/ftl/client_ftl/**", "anon");
