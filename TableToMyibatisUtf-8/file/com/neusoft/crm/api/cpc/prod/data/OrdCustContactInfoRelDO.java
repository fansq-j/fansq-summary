...
/**
 * @实体描述:记录订单变更的客户联系信息。
 * @实体表  :ORD_CUST_CONTACT_INFO_REL
 */
public class OrdCustContactInfoRelDO extends BaseDO{ 

   /**
    *主键对应的序列名称
    */
    public static final String ID_SEQ = "ORD_CUST_CONTACT_INFO_REL_S";
