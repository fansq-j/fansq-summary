...
/**
 * @实体描述:记录订单变更的销售品产品实例关系。
 * @实体表  :ORD_OFFER_PROD_INST_REL
 */
public class OrdOfferProdInstRelDO extends BaseDO{ 

   /**
    *主键对应的序列名称
    */
    public static final String ID_SEQ = "ORD_OFFER_PROD_INST_REL_S";
