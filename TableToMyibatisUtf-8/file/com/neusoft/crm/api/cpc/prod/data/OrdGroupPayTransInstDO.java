...
/**
 * @实体描述:记录订单变更的集团支付滚存实例。
 * @实体表  :ORD_GROUP_PAY_TRANS_INST
 */
public class OrdGroupPayTransInstDO extends BaseDO{ 

   /**
    *主键对应的序列名称
    */
    public static final String ID_SEQ = "ORD_GROUP_PAY_TRANS_INST_S";
