 ...
 * @实体表  :MKT_RES_EVENT
 */
public class MktResEventDO extends BaseDO{ 

   /**
    *主键对应的序列名称
    */
    public static final String ID_SEQ = "MKT_RES_EVENT_S";
    ...
    /**
     * 设置 事件类型，记录入库、出库、调拨、订单等触发的事件类型。LOVB=RES-C-0007
     */
    ...
    /**
     * 获取 事件类型，记录入库、出库、调拨、订单等触发的事件类型。LOVB=RES-C-0007
     */
