...
/**
 * @实体描述:描述对发票资源实例的操作事件
 * @实体表  :MKT_RES_INV_EVENT
 */
public class MktResInvEventDO extends BaseDO{ 

   /**
    *主键对应的序列名称
    */
    public static final String ID_SEQ = "MKT_RES_INV_EVENT_S";
    ...
    /**
     * 事件类型，记录入库、出库、调拨、订单等触发的事件类型，LOVB=RES-C-0024
     */
    ...
    /**
     * 设置 事件类型，记录入库、出库、调拨、订单等触发的事件类型，LOVB=RES-C-0024
     */
    ...
    /**
     * 获取 事件类型，记录入库、出库、调拨、订单等触发的事件类型，LOVB=RES-C-0024
     */
