...
/**
 * @实体描述:记录订单变更的销售品实例费用属性。
 * @实体表  :ORD_OFFER_INST_FEE_ATTR
 */
public class OrdOfferInstFeeAttrDO extends BaseDO{ 

   /**
    *主键对应的序列名称
    */
    public static final String ID_SEQ = "ORD_OFFER_INST_FEE_ATTR_S";
