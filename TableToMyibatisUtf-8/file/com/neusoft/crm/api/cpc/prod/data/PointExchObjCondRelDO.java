...
/**
 * @实体描述:记录积分兑换对象与积分兑换条件之间的兑换规则关系。
 * @实体表  :POINT_EXCH_OBJ_COND_REL
 */
public class PointExchObjCondRelDO extends BaseDO{ 

   /**
    *主键对应的序列名称
    */
    public static final String ID_SEQ = "POINT_EXCH_OBJ_COND_REL_S";

    /**
     * 积分兑换对象与兑换条件关系标识，作为主键
     */
    public java.lang.Integer pointExchObjCondRelId;
     ...
     */
    public void setPointExchObjCondRelId(java.lang.Integer pointExchObjCondRelId) {
        this.pointExchObjCondRelId = pointExchObjCondRelId;
    }

    /**
     * 获取 积分兑换对象与兑换条件关系标识，作为主键
     */
    public java.lang.Integer getPointExchObjCondRelId() {
        return this.pointExchObjCondRelId;
    }
    ...
    public java.lang.Integer doCreateId(){
         this.pointExchObjCondRelId = SeqUtils.createIntegerId(ID_SEQ);
         return this.pointExchObjCondRelId;
    }
