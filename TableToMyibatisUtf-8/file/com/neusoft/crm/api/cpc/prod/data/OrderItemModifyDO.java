...
/**
 * @实体描述:记录订单项变更记录，结构同订单项表，但仅存储修改前的历史信息。
 * @实体表  :ORDER_ITEM_MODIFY
 */
public class OrderItemModifyDO extends BaseDO{ 

   /**
    *主键对应的序列名称
    */
    public static final String ID_SEQ = "ORDER_ITEM_MODIFY_S";
     ...
     */
    public java.lang.Integer belongLanId;
    ...
    /**
     * 记录订单来源，例如IPAD或某个APP产生的订单，或从前台或批量的方式受理产生的订单。
     */
     ...
     */
    public void setBelongLanId(java.lang.Integer belongLanId) {
     ...
     */
    public java.lang.Integer getBelongLanId() {
    ...
    /**
     * 设置 记录订单来源，例如IPAD或某个APP产生的订单，或从前台或批量的方式受理产生的订单。
     */
    ...
    /**
     * 获取 记录订单来源，例如IPAD或某个APP产生的订单，或从前台或批量的方式受理产生的订单。
     */
