...
/**
 * @实体描述:描述了客户群的特征信息。客户群特征是将一定的客户属性进行固化，形成特有的特征，根据一定的特征抽取出的客户群将具备客户群特
 * @实体表  :CUST_GROUP_FEATURE
 */
public class CustGroupFeatureDO extends BaseDO{ 

   /**
    *主键对应的序列名称
    */
    public static final String ID_SEQ = "CUST_GROUP_FEATURE_S";
     ...
     * 记录客户群特征描述。
     */
    public java.lang.String featureDesc;
    ...
    public java.lang.Long doCreateId(){
         this.custGroupFeatureId = SeqUtils.createLongId(ID_SEQ);
         return this.custGroupFeatureId;
    }
