...
/**
 * @实体描述:记录营销资源仓库属性。
 * @实体表  :MKT_RES_STORE_ATTR
 */
public class MktResStoreAttrDO extends BaseDO{ 

   /**
    *主键对应的序列名称
    */
    public static final String ID_SEQ = "MKT_RES_STORE_ATTR_S";

    /**
     * 记录营销资源仓库属性标识
     */
    public java.lang.Long storeAttrId;
     ...
     * 设置 记录营销资源仓库属性标识
     */
    public void setStoreAttrId(java.lang.Long storeAttrId) {
     ...
     * 获取 记录营销资源仓库属性标识
     */
    public java.lang.Long getStoreAttrId() {
        return this.storeAttrId;
    }
    ...
    public java.lang.Long doCreateId(){
         this.storeAttrId = SeqUtils.createLongId(ID_SEQ);
         return this.storeAttrId;
    }
