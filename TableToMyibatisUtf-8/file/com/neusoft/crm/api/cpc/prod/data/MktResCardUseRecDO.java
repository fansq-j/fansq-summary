...
/**
 * @实体描述:1.营销资源卡使用记录，数据量太多，独立分表。按照号码、卡分别建一套表。亿迅。
2.修改实体“营销资源卡使用
 * @实体表  :MKT_RES_CARD_USE_REC
 */
public class MktResCardUseRecDO extends BaseDO{ 

   /**
    *主键对应的序列名称
    */
    public static final String ID_SEQ = "MKT_RES_CARD_USE_REC_S";

    /**
     * 营销资源使用记录ID的标识，主键
     */
    public java.lang.Integer mktResCardUseRecId;
     ...
     * 设置 营销资源使用记录ID的标识，主键
     */
    public void setMktResCardUseRecId(java.lang.Integer mktResCardUseRecId) {
     ...
     * 获取 营销资源使用记录ID的标识，主键
     */
    public java.lang.Integer getMktResCardUseRecId() {
        return this.mktResCardUseRecId;
    }
    ...
    public java.lang.Integer doCreateId(){
         this.mktResCardUseRecId = SeqUtils.createIntegerId(ID_SEQ);
         return this.mktResCardUseRecId;
    }
