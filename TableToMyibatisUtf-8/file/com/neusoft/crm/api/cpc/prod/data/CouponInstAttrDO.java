...
/**
 * @实体描述:记录优惠券实例属性信息。
 * @实体表  :COUPON_INST_ATTR
 */
public class CouponInstAttrDO extends BaseDO{ 

   /**
    *主键对应的序列名称
    */
    public static final String ID_SEQ = "COUPON_INST_ATTR_S";

    /**
     * 记录优惠券实例属性ID
     */
    public java.lang.Long couponInstAttrId;
     ...
     * 设置 记录优惠券实例属性ID
     */
    public void setCouponInstAttrId(java.lang.Long couponInstAttrId) {
        this.couponInstAttrId = couponInstAttrId;
    }

    /**
     * 获取 记录优惠券实例属性ID
     */
    public java.lang.Long getCouponInstAttrId() {
        return this.couponInstAttrId;
    }
    ...
    public java.lang.Long doCreateId(){
         this.couponInstAttrId = SeqUtils.createLongId(ID_SEQ);
         return this.couponInstAttrId;
    }
