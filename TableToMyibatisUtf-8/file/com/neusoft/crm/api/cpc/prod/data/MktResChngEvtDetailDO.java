...
/**
 * @实体描述:描述出入库详细信息，对于有序营销资源，记录营销资源实例的数量变化；对于无序营销资源，记录营销资源数量的变化
 * @实体表  :MKT_RES_CHNG_EVT_DETAIL
 */
public class MktResChngEvtDetailDO extends BaseDO{ 

   /**
    *主键对应的序列名称
    */
    public static final String ID_SEQ = "MKT_RES_CHNG_EVT_DETAIL_S";
