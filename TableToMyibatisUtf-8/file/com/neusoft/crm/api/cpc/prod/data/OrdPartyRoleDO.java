 ...
 * @实体表  :ORD_PARTY_ROLE
 */
public class OrdPartyRoleDO extends BaseDO{ 

   /**
    *主键对应的序列名称
    */
    public static final String ID_SEQ = "ORD_PARTY_ROLE_S";
    ...
    /**
     * 记录参与人角色的类型，包括客户、员工、合作伙伴、竞争对手、会员、俱乐部等。LOVB=PTY-0003。
     */
    ...
    /**
     * 设置 记录参与人角色的类型，包括客户、员工、合作伙伴、竞争对手、会员、俱乐部等。LOVB=PTY-0003。
     */
    ...
    /**
     * 获取 记录参与人角色的类型，包括客户、员工、合作伙伴、竞争对手、会员、俱乐部等。LOVB=PTY-0003。
     */
