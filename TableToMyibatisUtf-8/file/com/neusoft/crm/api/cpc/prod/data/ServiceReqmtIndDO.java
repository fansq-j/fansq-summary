...
/**
 * @实体描述:本实体是对服务等级实体的扩充。在服务等级实体中描述了某个参与人、客户、账户、产品实例的服务等级，在本实体中描述某个参与人
 * @实体表  :SERVICE_REQMT_IND
 */
public class ServiceReqmtIndDO extends BaseDO{ 

   /**
    *主键对应的序列名称
    */
    public static final String ID_SEQ = "SERVICE_REQMT_IND_S";

    /**
     * 记录个性化服务要求标识，作为主键
     */
    public java.lang.Long serviceReqmtIndId;

    /**
     * 记录服务等级实例标识，作为外键，指向服务等级实体
     */
     ...
     * 设置 记录个性化服务要求标识，作为主键
     */
    public void setServiceReqmtIndId(java.lang.Long serviceReqmtIndId) {
        this.serviceReqmtIndId = serviceReqmtIndId;
    }

    /**
     * 获取 记录个性化服务要求标识，作为主键
     */
    public java.lang.Long getServiceReqmtIndId() {
        return this.serviceReqmtIndId;
    }
    ...
    public java.lang.Long doCreateId(){
         this.serviceReqmtIndId = SeqUtils.createLongId(ID_SEQ);
         return this.serviceReqmtIndId;
    }
